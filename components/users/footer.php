    ...
    <div class="mx-auto max-w-full px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 xl:grid-cols-4">
            <div>
                ...
                <li>
                    <a href="#" rel="noreferrer" target="_blank" class="text-red-nano transition hover:text-red-nano/75">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:col-span-2">
                ...
                <ul class="mt-8 space-y-4 text-sm">
                    ...
                    <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="#">
                        ...
                        <span class="text-gray-700">021-62309578</span>
                    </a>
                    </li>
                    ...
                    <address class="-mt-0.5 text-gray-700 not-italic">
                        Mangga Dua Mall, Lantai 2 no 47A-B
                        <p class="text-gray-300">Senin - Minggu pukul 10.00 - 18.00 WIB</p>
                    </address>
                    </li>
                </ul>
                </div>
            ...
            <div class="text-center sm:text-left">
                ...
                <ul class="mt-8 space-y-4 text-sm">
                    ...
                    <form action="">
                        ...
                        <button
                        class="bg-red-nano text-white w-full py-2 mt-2 font-semibold rounded-lg hover:bg-red-nano/75">Berlangganan</button>
                    </form>
                </ul>
                </div>
        </div>
