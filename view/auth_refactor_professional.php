...
<style>
.container{position:relative;width:100%;height:650px;overflow:hidden}
.panel{position:absolute;top:0;height:100%;width:50%;transition:transform .6s ease}
.container.right-active .signin{transform:translateX(100%)}
.container.right-active .signup{transform:translateX(100%)}
</style>
</head>
