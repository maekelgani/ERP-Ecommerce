...
<style>
    ...
    .select2-container--default .select2-results__option--highlighted[aria-selected] {
        background: linear-gradient(135deg, #882426 0%, #a83236 100%) !important;
            ...
            <div class="tab-content-managementweb">
                <div class="rounded-xl border border-gray-100 bg-white shadow-sm p-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                        ...
                        <button id="btnAddStore" class="inline-flex items-center gap-2 px-4 py-2.5 text-white rounded-lg transition-all duration-300 hover:shadow-lg active:scale-95 font-medium" style="background: linear-gradient(135deg, #882426 0%, #6d1a1c 100%);">
                ...
                <div class="rounded-xl border border-gray-100 bg-white shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <button id="btnAddArticle" class="inline-flex items-center gap-2 px-4 py-2.5 text-white rounded-lg transition-all duration-300 hover:shadow-lg active:scale-95 font-medium" style="background: linear-gradient(135deg, #882426 0%, #6d1a1c 100%);">
                                <span class="material-symbols-outlined text-xl">add_circle</span>
                                Tambah Artikel
                            </button>
                        </div>
        ...
        <div class="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl transform transition-all duration-300">
            ...
            <form id="storeForm" class="overflow-y-auto max-h-[calc(90vh-80px)]">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border border-gray-100 shadow-sm">
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background: linear-gradient(135deg, #882426 0%, #a83236 100%);">
                ...
                <div class="sticky bottom-0 bg-white border-t border-gray-100 px-6 py-4 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-3 text-white rounded-xl transition-all duration-300 hover:shadow-lg font-medium flex items-center gap-2" style="background: linear-gradient(135deg, #882426 0%, #6d1a1c 100%);">
    ...
    <div id="articleModal" class="fixed inset-0 bg-black/50 z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl">
            <div class="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between z-10">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center" style="background: linear-gradient(135deg, #882426 0%, #a83236 100%);">
            ...
            <form id="articleForm" class="p-6 space-y-5 overflow-y-auto max-h-[calc(90vh-80px)]">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-white rounded-lg transition-all duration-300 hover:shadow-lg font-medium flex items-center gap-2" style="background: linear-gradient(135deg, #882426 0%, #6d1a1c 100%);">
                        <span class="material-symbols-outlined text-lg">save</span>
                        Simpan Artikel
                    </button>
                </div>
