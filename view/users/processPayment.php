                                ...
                                <div class="px-10 lg:px-25 mb-20">
                                    <div class="mb-4 border border-dashed p-4 border-gray-400 rounded-lg">
                                        ...
                                        <p class="text-red-400">
                                            ...
                                            <span class="text-xl font-semibold text-primary">56 </span>Detik
                                        </p>
                                    </div>
                                    <span class="text-sm font-semibold text-info">Pembayaran akan dibatalkan secara otomatis apabila dalam batas waktu di atas tidak dilakukan pembayaran</span>
                                </div>
